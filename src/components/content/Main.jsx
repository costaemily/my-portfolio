    ...
    <div>
      ...
      <DivSobreMim id="SobreMim">
        <DivTextoSobreMin>
          ...
          <TextoSobreMin>
            Estudante de Engenharia da Computação no Instituto Federal de
            Educação, Ciência e Tecnologia de São Paulo no Campus Birigui e
            Estagiária na Gorila Invest. Descobri a paixão por programação na
            ETEC onde cursei Técnico em Informárica e desde então o estudo se
        ...
        <DivFundoExperiencia>
          <DivExperienciaDesc>
            ...
            <ExperienciaDesc>
              <DescricaoExp>
                <TextoTituloExp>
                  Estagiária em desenvolvimento de software - Gorila Invest
                </TextoTituloExp>
                <TextoSubTituloExp>Outubro de 2022 - Hoje</TextoSubTituloExp>
                <DivTextoExp>
                  <TextoExp>
                    O Gorila organiza as informações do mercado de investimentos
                    para trazer clareza e te ajudar na tomada de decisões. Atuo
                    na squad de Platform Ops, onde fazemos Onboarding de novos
                    clientes B2Bs (Business-to-business) na plataforma do
                    Gorila. Atualmente atuo em automatizações de tarefas e
            ...
            <ExperienciaDesc>
              <DescricaoExp>
                <TextoTituloExp>
                  Estagiária em T.I. - IFSP - Birigui
                </TextoTituloExp>
                <TextoSubTituloExp>
                ...
                <DivTextoExp>
                  <TextoExp>
                    ...
                    Paulo – IFSP – é uma autarquia federal de ensino. Fundada em
                    1909, como Escola de Aprendizes Artífices, é reconhecida
                    pela sociedade paulista por sua excelência no ensino público
                    gratuito de qualidade. As atividades desenvolvidas no
                    estágio envolveram: Publicações de notícias e assuntos no
                    site institucional; Atendimento de chamados de usuários
                    Docentes e Administrativos; Auxílio na construção da
                    infraestrutura de rede do novo laboratório IFMaker da
                    instituição; Auxílio na montagem de cabos de rede para as
                    novas catracas; Manutenções simples de laboratórios de
                    informática e Instalações de softwares nos computadores dos
          ...
          <DivProjetoDisc>
            ...
            <DivProjetosDescricao>
              ...
              >
                ...
                <TextoLink>
                  Este repositório contem o projeto de controle de estoque de
                  peças.
                </TextoLink>
                <DivTags>
                  <Tags>REACT</Tags>
              ...
              >
                ...
                <TextoLink>
                  Este repositório contem o projeto de uma lista de tarefas
              ...
              >
                ...
                <TextoLink>
                  Este repositório possui um simulador de algoritmos de
                  paginação.
                </TextoLink>
                <DivTags>
                  <Tags>C#</Tags>
              ...
              >
                ...
                <TextoLink>
                  Este repositório contém um projeto que simula Sistemas de
